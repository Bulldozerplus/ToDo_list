                ...
                : tasks.filter(days => days.timeStamp === day).map((task, index) => (
                    editList === task.id
                        ? <form>
                            ...
                            <input value={editTask.description}
                                   placeholder='edit the description'
                                   onChange={event => setEditTask({...editTask, description: event.target.value})}/>
                            <input value={editTask.timeStamp}
                                   placeholder='edit the day'
                                   onChange={event => setEditTask({...editTask, timeStamp: event.target.value})}/>
